...
const Sidebar = () => {const [showMenu, setShowMenu] = useState(0);
  ...
  <nav className="nav" id="navAll">
    ...
    <section className="catNav" id="catNav">
      <NavLink to="/communicatie" activeStyle={{backgroundColor: "#2b2d2e"}}>
      ...
      <NavLink to="/ergonomie" activeStyle={{backgroundColor: "#2b2d2e"}}>
      ...
      <NavLink to="/kabel" activeStyle={{backgroundColor: "#2b2d2e"}}>
      ...
      <NavLink to="/print" activeStyle={{backgroundColor: "#2b2d2e"}}>
      ...
      <NavLink to="/randapparatuur" activeStyle={{backgroundColor: "#2b2d2e"}}>
      ...
      <NavLink to="/werkplek" activeStyle={{backgroundColor: "#2b2d2e"}}>
