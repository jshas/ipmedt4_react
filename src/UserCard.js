    ...
    return (
      <section className="userCard">
        ...
        <figure className="userCard__fig">
          <br />
          <img className="userCard__fig__img" src={"http://127.0.0.1:8000" + props.value.img_path} alt={props.value.img_path} />
        </figure>

        <h1 className="userCard__name">{props.value.first_name} {props.value.last_name}</h1>
